...
[root@localhost home]# #使用mkdir命令创建jinronga目录
[root@localhost home]# mkdir jinronga

[root@localhost home]# #进入jinronga目录
[root@localhost home]# cd jinronga

[root@localhost jinronga]# #返回上一级目录
[root@localhost jinronga]# cd ..

[root@localhost home]# #回到根目录
[root@localhost home]# cd /

[root@localhost /]# #表示回到自己的家目录 即是/root这个目录
[root@localhost /]# cd ~
...
[root@localhost ~]# pwd
/root
[root@localhost ~]# #如果是链接，要显示真实的地址，可以是 -P参数
[root@localhost ~]# pwd -P
...
![image-20200605160506916](2.LInux基本命令(掌握).assets/image-20200605160506916.png)
...
![image-20200605160522014](2.LInux基本命令(掌握).assets/image-20200605160522014.png)
