...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <context:component-scan base-package="cn.jinronga.contorller"/>
    <!-- 让Spring MVC不处理静态资源 -->
...
public String json2() throws JsonProcessingException {
   ...
   ObjectMapper mapper = new ObjectMapper();
   //创建一个对象
   User user1 = new User(1,"金融啊",18);
   User user2 = new User(1,"金融啊",18);
   User user3 = new User(1,"金融啊",18);
   User user4 = new User(1,"金融啊",18);
